...
// Polymorphic type: default "button"
...
const getButtonStyle = (variant: ButtonVariant = "primary"): React.CSSProperties => {
  ...
  switch (variant) {
    case "outline":
      return { ...base, background: "transparent", color: "#2563eb", borderColor: "#2563eb" };
    case "ghost":
      return { ...base, background: "transparent", color: "#111827", borderColor: "transparent" };
    case "primary":
    default:
